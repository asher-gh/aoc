...
Your puzzle answer was **`3731`**.

> Key Observation: new tiles are reached only at even steps, so we don't count
> odd steps.
...
Your puzzle answer was **`617565692567199`**.

**Observations**

- The starting point is at center of the input.
- The input size is `131x131`, which is exactly `65` on each side.
- The row and column, that starting point is, are all `.`
- Number of steps, `26501365` = `65 + (131 * 2023)`.
